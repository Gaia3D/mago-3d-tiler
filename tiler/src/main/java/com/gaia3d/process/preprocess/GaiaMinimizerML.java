...
//            Matrix4d matrix = rootNode.getTransformMatrix();
//            Matrix4d preMultipliedMat = rootNode.getPreMultipliedTransformMatrix();
//            preMultipliedMat.set(matrix);
    ...
    private GaiaScene marchingCubeVoxelization(TileInfo tileInfo, GaiaScene scene) {
        ...
        voxelSizeMeter = 0.5; // for DCLibrary.***
        texturePixelsForMeter = 30.0; // for DCLibrary.***

        // tree settings.***
        voxelSizeMeter = 0.2; // tree.***
        texturePixelsForMeter = 80.0; // for tree.***
//
