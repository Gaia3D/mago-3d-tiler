...
public enum ProcessOptions {
    ...
    IGNORE_TEXTURES("ignoreTextures", "igtx", false,"Ignore diffuse textures. "),
    ...
    DEBUG("debug", "d", false,"More detailed log output and stops on Multi-Thread bugs."),
    DEBUG_GLB("glb", "glb", false, "Create glb file with B3DM."),
