...
public final class MagoShaderPrograms {
    ...
    public static final MagoShaderProgram TEXTURED = new MagoShaderProgram("textured", new MagoDefaultVertexShader(), new MagoTexturedFragmentShader());

    public static final MagoShaderProgram FACE_CODE = new MagoShaderProgram("face-code", new MagoDefaultVertexShader(), new MagoFaceCodeFragmentShader());
