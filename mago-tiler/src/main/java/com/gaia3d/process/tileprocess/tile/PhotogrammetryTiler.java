...
//            tilerExtensionModule.getColorAndDepthRender(sceneInfos,
//                    bufferedImageType,
//                    resultImages,
//                    nodeBBoxLC,
//                    nodeTMatrix,
...
//                    maxDepthScreenSize);
    ...
    public boolean integralLeafScenes(List<TileInfo> tileInfos,
        ...
        for (int i = 0; i < nodesCount; i++) {
            ...
            String outputPathString = globalOptions.getOutputPath();
            String nodeName = "node_L_" + nodeDepth + "_" + i;
            tilerExtensionModule.integralLeafScene(sceneInfos,
                    resultGaiaScenes,
                    nodeBBoxLC,
                    nodeTMatrix,
                    maxScreenSize,
...
//        }
    ...
    private void makeContentsForNode(Node node, GaiaScene gaiaScene, int lod, int nodeDepth, int nodeIdx){
        ...
        if(gaiaScene.getOriginalPath() == null){
            log.warn("Warning : originalPath is null. Set originalPath to 'ddd'. node");
            Path originalPath = Path.of("ddd");
