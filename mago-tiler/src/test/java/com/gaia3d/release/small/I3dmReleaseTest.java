...
class I3dmReleaseTest {
    ...
    void instanced01() {
        ...
        String[] args = new String[] {
                ...
                "-ot", "i3dm",
                "-refineAdd",
                "-instance", ReleaseTestConfig.getInputPath(path).getAbsolutePath() + "/tree.dae",
                "-terrain", ReleaseTestConfig.getInputPath(path).getAbsolutePath() + "/seoul-aster.tif",
                "-c", "5186"
        };
        ReleaseTestConfig.execute(args);
    }
    ...
    void instanced04() {
        ...
        String[] args = new String[] {
                ...
                "-c", "5179",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath(path).getAbsolutePath() + "/needle-tree.glb",
                "-terrain", ReleaseTestConfig.INPUT_PATH + "/korea-compressed.tif",
                //"-debug"
        };
        ReleaseTestConfig.execute(args);
    }
    ...
    void instanced04Extend() {
        ...
        String[] args = new String[] {
                ...
                "-c", "5179",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath(path).getAbsolutePath() + "/lowpoly-tree-broad-leaved-big.glb",
                "-terrain", ReleaseTestConfig.INPUT_PATH + "/korea-compressed.tif",
                //"-debug"
        };
        ReleaseTestConfig.execute(args);
    ...
    void instanced06A() {
        ...
        String[] args = new String[] {
                "-i", ReleaseTestConfig.getInputPath(path).getAbsolutePath(),
                "-o", ReleaseTestConfig.getOutputPath("ESD/" + path).getAbsolutePath() + "-A",
                "-c", "5179",
                "-it", "gpkg",
                "-ot", "i3dm",
                "-refineAdd",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/broad-tree-1m.glb",
    ...
    void instanced06B() {
        ...
        String[] args = new String[] {
                "-i", ReleaseTestConfig.getInputPath(path).getAbsolutePath(),
                "-o", ReleaseTestConfig.getOutputPath("ESD/" + path).getAbsolutePath() + "-B",
                "-c", "5179",
                "-it", "gpkg",
                "-ot", "i3dm",
                "-refineAdd",
    ...
    void instanced06C() {
        ...
        String[] args = new String[] {
                "-i", ReleaseTestConfig.getInputPath(path).getAbsolutePath(),
                "-o", ReleaseTestConfig.getOutputPath("ESD/" + path).getAbsolutePath() + "-C",
                "-c", "5179",
                "-it", "gpkg",
                "-ot", "i3dm",
                "-refineAdd",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/mix-tree-1m.glb",
                "-terrain", "G:/workspace/dem05-cog.tif",
    ...
    void instanced06D() {
        ...
        String[] args = new String[] {
                "-i", ReleaseTestConfig.getInputPath(path).getAbsolutePath(),
                "-o", ReleaseTestConfig.getOutputPath("ESD/" + path).getAbsolutePath() + "-D",
                "-c", "5179",
                "-it", "gpkg",
                "-ot", "i3dm",
                "-refineAdd",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/bamboo-tree-1m.glb",
                "-terrain", "G:/workspace/dem05-cog.tif",
    ...
    void instanced06Merger() {
        String path = "ESD";
        String[] args = new String[] {
                "-i", ReleaseTestConfig.getOutputPath(path).getAbsolutePath(),
                "-o", ReleaseTestConfig.getOutputPath(path).getAbsolutePath(),
                //"-c", "5179",
                "-merge",
                //"-ot", "i3dm",
    ...
    void instanced07Chim() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/chim-sample.glb",
    ...
    void instanced07jat() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/jat-sample.glb",
                "-terrain", "G:/workspace/dem05.tif",
                //"-debug"
        };
        ReleaseTestConfig.execute(args);
    ...
    void instanced07Hwal() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/hwal-sample.glb",
                "-terrain", "G:/workspace/dem05.tif",
                //"-debug"
        };
        ReleaseTestConfig.execute(args);
    ...
    void instanced07Nak() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/nak-sample.glb",
                "-terrain", "G:/workspace/dem05.tif",
                //"-debug"
        };
        ReleaseTestConfig.execute(args);
    ...
    void instanced07Buts() {
        ...
        String[] args = new String[] {
                "-i", ReleaseTestConfig.getInputPath(path).getAbsolutePath(),
                "-o", ReleaseTestConfig.getOutputPath(path).getAbsolutePath()+"-cherry-blossom",
                "-c", "5187",
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", ReleaseTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/cherry-blossom.glb",
                "-terrain", "G:/workspace/dem05.tif",
        };
        ReleaseTestConfig.execute(args);
    }
    ...
    void instanced08() {
        ...
        String[] args = new String[] {
                ...
                "-ot", "i3dm",
                "-refineAdd",
                "-instance", ReleaseTestConfig.getInputPath(path).getAbsolutePath() + "/lite.glb",
                "-terrain", "G:/workspace/dem05.tif",
        };
        ReleaseTestConfig.execute(args);
    }
    ...
    void instance10E() {
        ...
        String[] args = new String[] {
                ...
                "--scaleColumn", "rel_height_m",
                "--instance", "D:\\data\\mago-3d-tiler\\release-sample\\sample-tree\\broad-tree-1m.glb",
                "-terrain", ReleaseTestConfig.getInputPath(path).getAbsolutePath() + "/hamilton_dem_navd88_meters_4326.tif",
        };
        ReleaseTestConfig.execute(args);
    }
    ...
    void runWithSimple() throws IOException {
        ...
        argList.add("--rm");
        argList.add("-v");
        argList.add(ReleaseTestConfig.INPUT_PATH + ":/input");
        argList.add("-v");
        argList.add(ReleaseTestConfig.OUTPUT_PATH + ":/output");
