...
class I3dmReleaseTest {
    ...
    void instanced01() {
        ...
        String[] args = new String[] {
                ...
                "-ot", "i3dm",
                "-refineAdd",
                "-instance", MagoTestConfig.getInputPath(path).getAbsolutePath() + "/tree.dae",
                "-terrain", MagoTestConfig.getInputPath(path).getAbsolutePath() + "/seoul-aster.tif",
                "-c", "5186"
        };
        MagoTestConfig.execute(args);
    }
    ...
    void instanced04() {
        ...
        String[] args = new String[] {
                ...
                "-terrain", MagoTestConfig.INPUT_PATH + "/korea-compressed.tif",
                //"-debug"
        };
        MagoTestConfig.execute(args);
    }
    ...
    void instanced07Chim() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", MagoTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/chim-sample.glb",
    ...
    void instanced07jat() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", MagoTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/jat-sample.glb",
                "-terrain", "G:/workspace/dem05.tif",
                //"-debug"
        };
        MagoTestConfig.execute(args);
    ...
    void instanced07Hwal() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", MagoTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/hwal-sample.glb",
                "-terrain", "G:/workspace/dem05.tif",
                //"-debug"
        };
        MagoTestConfig.execute(args);
    ...
    void instanced07Nak() {
        ...
        String[] args = new String[] {
                ...
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", MagoTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/nak-sample.glb",
                "-terrain", "G:/workspace/dem05.tif",
                //"-debug"
        };
        MagoTestConfig.execute(args);
    ...
    void instanced07Buts() {
        ...
        String[] args = new String[] {
                "-i", MagoTestConfig.getInputPath(path).getAbsolutePath(),
                "-o", MagoTestConfig.getOutputPath(path).getAbsolutePath()+"-cherry-blossom",
                "-c", "5187",
                "-it", "shp",
                "-ot", "i3dm",
                "-instance", MagoTestConfig.getInputPath("sample-tree").getAbsolutePath() + "/cherry-blossom.glb",
                "-terrain", "G:/workspace/dem05.tif",
        };
        MagoTestConfig.execute(args);
    }
    ...
    void runWithSimple() throws IOException {
        ...
        argList.add("--rm");
        argList.add("-v");
        argList.add(MagoTestConfig.INPUT_PATH + ":/input");
        argList.add("-v");
        argList.add(MagoTestConfig.OUTPUT_PATH + ":/output");
