...
import com.gaia3d.engine.graph.*;
...
public class Main implements IAppLogic {
    ...
    public static void main(String[] args) {
        ...
        for (GaiaScene gaiaScene : gaiaScenes) {
            gaiaScenesContainer.addGaiaScene(gaiaScene);
        }
    ...
    public void init(Window window, Scene scene, Render render) {
        ...
        int[] indices = new int[]{
                ...
                // Back face
                4, 6, 7, 5, 4, 7,};
        Texture texture = scene.getTextureCache().createTexture("D:/Java_Projects/mago-3d-tiler/renderer/src/main/resources/models/cube/cube.png");
